...
print(transmission_collected, transmission_collected_integrated)

im4=ax4.plot(wavelengths/nm,transmission_collected/max(transmission_collected))
im4=ax4.plot(wavelengths/nm,transmission_collected_integrated/max(transmission_collected_integrated))
